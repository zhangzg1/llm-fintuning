...
model_path = '../llm-fintuning/models/Qwen2-7B-Instruct-lora'
quant_path = '../llm-fintuning/models/Qwen2-7B-Instruct-lora-awq'
...
dataset_path = "../dataset/mit-han-lab/pile-val-backup"
